...
final class Loader
{
	...
	static function autoload() {
		...
		$vendorDir = WNCM_PATH . 'includes';

		$psr = array(
		    'WebinaneCommerce\\' => array($vendorDir),
		);
		...
		require_once WNCM_PATH . 'includes/Gateways.php';

	}

	static function includes() {
		require_once WNCM_PATH .'includes/Libraries/ClassLoader.php';
